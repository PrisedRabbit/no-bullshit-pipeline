...
@available(macOS 13.0, iOS 16.0, *)
public final class VadANEOptimizer {
    public static let aneAlignment = VadANEUtils.aneAlignment
    public static let aneTileSize = VadANEUtils.aneTileSize
    ...
    public func createAlignedArray(
        ...
        return try VadANEUtils.createAlignedArray(
            shape: shape,
            dataType: dataType,
            zeroClear: true
        )
...
@available(macOS 13.0, iOS 16.0, *)
public class VadFeatureProvider: NSObject, MLFeatureProvider {
...
@objc public class VADProcessor: NSObject {
    ...
    private let memoryOptimizer = VadANEOptimizer()
    ...
    private func warmupModel() {
        ...
        do {
            ...
            let featureProvider = VadFeatureProvider(features: [
...
// prefetchToNeuralEngine extension removed (FluidAudio provides it).
@_cdecl("vad_create")
