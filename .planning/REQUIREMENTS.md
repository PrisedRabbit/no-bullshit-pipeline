...
- [x] **PIPE-02**: User can create, edit, and delete pipelines with Processing and Delivery steps
...
- [x] **PIPE-05**: Multiple pipelines can be assigned to a single recording, each writing to its own output directory
...
- [x] **NOTN-03**: Setup wizard: user picks database from list fetched via Notion API
- [x] **NOTN-04**: Setup wizard: app reads database schema (properties, select options, people) automatically
- [x] **NOTN-05**: Setup wizard: user maps conversation aliases to Notion workspace users (people mapping)
